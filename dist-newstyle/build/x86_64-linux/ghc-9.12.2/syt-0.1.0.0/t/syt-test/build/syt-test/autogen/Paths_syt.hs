...
-- at runtime using the environment variable syt_bindir.
...
-- environment variable syt_libdir.
...
-- using the environment variable syt_dynlibdir.
...
-- runtime using the environment variable syt_datadir.
...
-- using the environment variable syt_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33/syt-0.1.0.0-inplace-syt-test"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.12.2-9b33/syt-0.1.0.0"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.12.2-9b33/syt-0.1.0.0"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "syt_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "syt_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "syt_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "syt_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "syt_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "syt_sysconfdir") (\_ -> return sysconfdir)
